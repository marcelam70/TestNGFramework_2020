...
public void verifyContactPageTitle(){
	...
	Assert.assertEquals(title, Constants.CONTACTS_PAGE_TILTE);
}
@DataProvider
...
public void createNewContactTest(String email,String firsname,String lastname,String jobtitle) throws InterruptedException{
	contactsPage.createNewContact(email, firsname, lastname, jobtitle);
}
 @AfterMethod
